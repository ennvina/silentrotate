...
L["APPEND_TARGET_DESC"] = "When a player casts a spell or a buff on a single target, append the name of the target next to the name of the caster; this option has no effect for AoE spells"
