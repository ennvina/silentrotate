...
local L = {
    ...
    ["LOADED_MESSAGE"] = "SilentRotate 已加載, 輸入 /silentrotate 進入設定",
    ["TRANQ_WINDOW_HIDDEN"] = "SilentRotate 窗口隱藏. 輸入 /silentrotate toggle 顯示窗口",

    -- Settings
    ["SETTING_GENERAL"] = "General",
    ["SETTING_GENERAL_REPORT"] = "請報告問題: ",
    ["SETTING_GENERAL_DESC"] = "New : SilentRotate will now play a sound when you need to shoot your tranqshot ! There are also few more display options to make the addon less intrusive.",
    ...
    ["WINDOW_LOCKED"] = "SilentRotate: 窗口已隱藏",
    ["WINDOW_UNLOCKED"] = "SilentRotate: 窗口已鎖定",
    ...
    ["DBM_SOUND_WARNING"] = "DBM在瘋狂時播放的'flag taken'提示音，可能導致您無法聽到SilentRotate的提示音。建議選擇壹個響亮的提示音，或者在DBM中禁用瘋狂的警告。",
