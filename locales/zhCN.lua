...
local L = {
    ...
    ["LOADED_MESSAGE"] = "SilentRotate 已加载, 输入 /silentrotate 进入设置",
    ["TRANQ_WINDOW_HIDDEN"] = "SilentRotate 窗口隐藏. 输入 /silentrotate toggle 显示窗口",

    -- Settings
    ["SETTING_GENERAL"] = "一般",
    ["SETTING_GENERAL_REPORT"] = "请报告问题: ",
    ["SETTING_GENERAL_DESC"] = "新内容: SilentRotate 当你需要施放你的宁神射击时，现在将播放一个声音!也有一些显示选项，可以减少插件得干扰。",
    ...
    ["WINDOW_LOCKED"] = "SilentRotate: 窗口已隐藏",
    ["WINDOW_UNLOCKED"] = "SilentRotate: 窗口已锁定",
    ...
    ["DBM_SOUND_WARNING"] = "DBM在激怒时播放的'flag taken'提示音，可能导致您无法听到SilentRotate的提示音。建议选择一个响亮的提示音，或者在DBM中禁用激怒的警告。",
