...
local L = {
    ...
    ["LOADED_MESSAGE"] = "SilentRotate загружен, введите /silentrotate для настройки",
    ["TRANQ_WINDOW_HIDDEN"] = "Окно SilentRotate скрыто. Введите /silentrotate toggle для отображения",

    -- Settings
    ["SETTING_GENERAL"] = "Общие",
    ["SETTING_GENERAL_REPORT"] = "Пожалуйста о всех ошибках сообщайте на",
    ["SETTING_GENERAL_DESC"] = "Новое: Теперь SilentRotate проигрывает звук когда подходит ваша очередь! Добавлено несколько настроек отображения, чтобы сделать аддон менее навязчивым.",
    ...
    ["WINDOW_LOCKED"] = "SilentRotate: Окно закреплено",
    ["WINDOW_UNLOCKED"] = "SilentRotate: Окно откреплено",
    ...
    ['TRANQ_SPELL_TEXT'] = "Усмиряющий выстрел",
    ['MC_SPELL_TEXT'] = "Контроль над разумом",
    ...
    ["DBM_SOUND_WARNING"] = "DBM проигрывает звук для каждого Бешенства, из-за этого вы можете не устышать оповещение от SilentRotate. Рекомендуется выбрать хорошо различимый звук для SilentRotate или отключить оповещение от DBM",
