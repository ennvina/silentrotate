		...
		args = {
            ...
            modes = {
                ...
                args = {
                    ...
                    -- },
                    -- tranqShotModeButton = {
                    --     name = L["TRANQSHOT_MODE_FULL_NAME"],
                    --     desc = string.format(L["MODE_BUTTON_DESC"], L["TRANQSHOT_MODE_FULL_NAME"])..".\n"..L["TRANQSHOT_MODE_DETAILED_DESC"],
                    --     type = "toggle",
                    --     order = 11,
                    --     width = "full",
                    --     set = setForMode,
                    ...
                    -- tranqShotModeText = {
                    --     name = L["MODE_LABEL"],
                    --     desc = string.format(L["MODE_LABEL_DESC"], L["TRANQSHOT_MODE_FULL_NAME"]),
                    --     type = "input",
                    --     order = 12,
                    --     width = "half",
                    --     set = setForMode,
                    --     hidden = function() return not SilentRotate.db.profile.tranqShotModeButton end,
                    -- },
                    -- tranqShotModeInvisible = {
                    --     name = SilentRotate.colors.lightRed:WrapTextInColorCode(L["MODE_INVISIBLE"]),
                    --     type = "description",
                    --     fontSize = "medium",
                    --     width = "full",
                    --     order = 13,
                    --     hidden = function() return SilentRotate.db.profile.tranqShotModeButton or not SilentRotate:isTranqShotMode() end,
                    -- },
                    -- loathebModeHeader = {
                    --     type = "header",
                    --     order = 20,
                    ...
                    -- },
                    -- bloodlustModeButton = {
                    --     name = L["BLOODLUST_MODE_FULL_NAME"],
                    --     desc = string.format(L["MODE_BUTTON_DESC"], L["BLOODLUST_MODE_FULL_NAME"])..".\n"..L["BLOODLUST_MODE_DETAILED_DESC"],
                    --     type = "toggle",
                    --     order = 81,
                    --     width = "full",
                    --     set = setForMode,
                    ...
                    -- bloodlustModeText = {
                    --     name = L["MODE_LABEL"],
                    --     desc = string.format(L["MODE_LABEL_DESC"], L["BLOODLUST_MODE_FULL_NAME"]),
                    --     type = "input",
                    --     order = 82,
                    --     width = "half",
                    --     set = setForMode,
                    --     hidden = function() return WOW_PROJECT_ID == WOW_PROJECT_CLASSIC or not SilentRotate.db.profile.bloodlustModeButton end,
                    -- },
                    -- bloodlustModeInvisible = {
                    --     name = SilentRotate.colors.lightRed:WrapTextInColorCode(L["MODE_INVISIBLE"]),
                    --     type = "description",
                    --     fontSize = "medium",
                    --     width = "full",
                    --     order = 83,
                    --     hidden = function() return WOW_PROJECT_ID == WOW_PROJECT_CLASSIC or SilentRotate.db.profile.bloodlustModeButton or not SilentRotate:isBloodlustMode() end,
                    -- },
                }
            },
            announces = {
                ...
                args = {
                    ...
                    --     hidden = function() return WOW_PROJECT_ID == WOW_PROJECT_CLASSIC end,
                    -- },
                    -- announceBloodlustMessage = {
                    --     name = L["BLOODLUST_MESSAGE_LABEL"],
                    --     type = "input",
                    --     order = 32,
                    --     width = "double",
                    --     hidden = function() return WOW_PROJECT_ID == WOW_PROJECT_CLASSIC end,
    ...
    for modeName, mode in pairs(SilentRotate.modes) do
        ...
        if (mode.canFail) then
            options.args.announces.args["announce"..mode.modeNameFirstUpper.."SuccessMessage"] = {
                name = L[mode.modeNameUpper.."_SUCCESS_MESSAGE_LABEL"],
                type = "input",
                order = announceIndex,
                width = "double",
                hidden = not mode.project,
            ...
            options.args.announces.args["announce"..mode.modeNameFirstUpper.."FailMessage"] = {
                name = L[mode.modeNameUpper.."_FAIL_MESSAGE_LABEL"],
                type = "input",
                order = announceIndex,
                width = "double",
                hidden = not mode.project,
            ...
            options.args.announces.args["announce"..mode.modeNameFirstUpper.."Message"] = {
                name = L[mode.modeNameUpper.."_MESSAGE_LABEL"],
                type = "input",
                order = announceIndex,
                width = "double",
                hidden = not mode.project,
